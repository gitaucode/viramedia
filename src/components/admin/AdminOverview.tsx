...
export default function AdminOverview(){
 ...
 const snapshot=[
  ...
  ["Active",s.activeCampaigns],
  ["Approved creators",s.approvedCreators],
  ["Open actions",s.openActions]
 ] as const;
